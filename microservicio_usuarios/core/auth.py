...
def get_mgmt_api():
    return os.getenv("AUTH0_MGMT_API")

def get_roleid(role: str):
    id: str = ""
    match role:
        case "secretaria":
            id = os.getenv("AUTH0_ROL_SECRETARIA")
        case "enfermero":
            id = os.getenv("AUTH0_ROL_ENFERMERA")
        case "psicologo":
            id = os.getenv("AUTH0_ROL_PSICOLOGO")
        case "psiquiatra":
            id = os.getenv("AUTH0_ROL_PSIQUIATRA")
        case "director":
            id = os.getenv("AUTH0_ROL_DIRECTOR")
        case "coordinador":
            id = os.getenv("AUTH0_ROL_COORDINADOR")
        case "paciente":
            id = os.getenv("AUTH0_ROL_PACIENTE")
        case _:  
            id = "norole"
    return id